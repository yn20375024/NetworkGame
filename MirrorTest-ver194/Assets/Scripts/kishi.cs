...
public class kishi: NetworkBehaviour
{
    ...
    void KeyCheck( float h, float v )
    {
        ...
        {
            m_Animator.animator.SetInteger("Tilt2",1);
            Debug.Log("強攻撃２");
        }
        else
        {
            m_Animator.animator.SetInteger("Tilt2", 2);
        }
        ...
        else if (Input.GetKeyDown("joystick button 4"))
        {
            ...
            {
                m_Animator.animator.SetInteger("GuardWalk", 1);
            }
            lrcheck2 = 0;
            Debug.Log("ガード");
        }
        ...
        else if (Input.GetKeyUp("joystick button 4"))
        {
            ...
            m_Animator.animator.SetInteger("GuardWalk", 2);
            lrcheck2 = 0;
        }
        //【 L1　ターゲット切り替え左 】
